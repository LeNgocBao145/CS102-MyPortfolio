...
export const EMAIL = 'himagito@gmail.com'

export const WEB_TITLE = 'LE DUC NGOC BAO - Personal Website'
export const WEB_DESCRIPTION =
  'A personal website showcasing my work and projects.'
export const FOOTER_COPYRIGHT = '© 2025 LE DUC NGOC BAO.'
export const FOOTER_LINK = 'https://github.com/lengocbao145/'

export const NAME = 'LE DUC NGOC BAO'
export const JOB_TITLE = 'DevOps Engineer'
...
export const SOCIAL_LINKS: SocialLink[] = [
  {
    label: 'GitHub',
    link: 'https://github.com/lengocbao145/',
  },
]
